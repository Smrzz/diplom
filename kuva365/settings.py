"""
Django settings for kuva365 project.
...
SECRET_KEY = 'django-insecure-s8$1(a4_5^5#2ib62u(itkv_2oy7-5+xrm4_q&#)g_h*s16^h+'
...
WSGI_APPLICATION = 'kuva365.wsgi.application'
